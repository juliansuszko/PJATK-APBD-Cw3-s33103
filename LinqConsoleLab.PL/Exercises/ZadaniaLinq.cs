...
public sealed class ZadaniaLinq
{
    ...
    {
        var pierwszyPrzedmiot = DaneUczelni.Przedmioty
            .FirstOrDefault(p => p.Kategoria == "Analytics");

        if (pierwszyPrzedmiot == null)
        {
            return new List<string> {"Brak przedmiotu w tej kategorii."};
        }

        return new List<string> { $"{pierwszyPrzedmiot.Nazwa}, {pierwszyPrzedmiot.DataStartu}" };
    }
    ...
    public IEnumerable<string> Zadanie07_LiczbaAktywnychZapisow()
    {
        ...
        return new List<string> { $"{aktywneZapisy}" };
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(pz => pz.Zapis.OcenaKoncowa != null)
            .GroupBy(pz => pz.Przedmiot.Nazwa)
            .Select(grupa => $"{grupa.Key}: {grupa.Average(pz => pz.Zapis.OcenaKoncowa)}");
    }
    ...
    public IEnumerable<string> Wyzwanie02_PrzedmiotyStartujaceWKwietniuBezOcenKoncowych()
    {
        return DaneUczelni.Przedmioty
            ...
            .Where(p => !DaneUczelni.Zapisy.Any(z => z.PrzedmiotId == p.Id && z.OcenaKoncowa != null))
            .Select(p => p.Nazwa);
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            .Select(pr =>
            {
                ...
                return $"{pr.Imie} {pr.Nazwisko} {wynik}";
            });
    }
